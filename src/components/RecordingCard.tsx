...
function RecordingCard({ recording }: { recording: CallRecording }) {
  ...
  return (
    <Card className="group hover:shadow-md transition-all">
      ...
      <CardContent>
        <div
          className="w-full aspect-video bg-muted rounded-lg flex items-center justify-center cursor-pointer group"
          onClick={() => window.open(recording.url, "_blank")}
        >
          <div className="size-12 rounded-full bg-background flex items-center justify-center group-hover:bg-primary transition-colors">
